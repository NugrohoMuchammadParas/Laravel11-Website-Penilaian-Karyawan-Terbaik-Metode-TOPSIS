                                ...
                                <div class="row mt-5">
                                    <div class="col-8 offset-2 bg-black rounded shadow">
                                        <form action="register-data" method="POST" id="formInput" autocomplete="off">
                                            ...
                                            <br>
                                            <button type="button" id="simpan_tambah"
                                                class="btn btn-sm btn-info btn-rounded w-75 fw-bold mb-1">Simpan</button>
                                            <hr style="color:white;">
                                            <button type="button" id="kembali" data-pages="<?= $kembali ?>"
                                                class="btn btn-sm btn-info btn-rounded w-75 fw-bold mb-1 mt-1">Kembali</button>
                                            <hr style="color:white;">
                                        </form>
                                    </div>
                                </div>
